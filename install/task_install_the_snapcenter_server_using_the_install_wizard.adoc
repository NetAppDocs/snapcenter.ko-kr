...
PowerShell cmdlet을 사용하여 여러 설치 및 구성 절차를 선택적으로 수행할 수 있습니다. PowerShell 7.4.13 이상을 사용해야 합니다.
...
** NET 확장성 4.5
** 응용 프로그램 초기화
** ASP.NET Core 10.0.7 호스팅 번들(또는 이후 버전). 특정 SnapCenter 버전에 맞는 최신 ASP.NET Core 버전은 link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter 소프트웨어 릴리스 노트"^]을 참조하십시오.
** 서버 측 포함
** WebSocket 프로토콜
...
+
** TCP 활성화
** HTTP 활성화에 대해서는 link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter 소프트웨어 릴리스 노트"^]사용 중인 SnapCenter 버전에 맞는 최신 ASP.NET Core 버전을 참조하십시오.
