...
* '보안 로그인 역할 생성 - role SVM_SVM_Role_Name - cmddirname "SnapMirror list-destinations" - vserver SVM_Name - 모두 액세스'
* '보안 로그인 역할 생성 - role SVM_SVM_Role_Name - cmddirname" event generate-autosupport-log" - vserver SVM_Name - 모두 액세스'
* '보안 로그인 역할 생성 - vserver SVM_Name - role SVM_SVM_Role_Name - cmddirname "작업 기록 표시" - 모두 액세스'
* '보안 로그인 역할 생성 - vserver SVM_Name - role SVM_SVM_Role_Name - cmddirname "job stop" - 모두 액세스'
* '보안 로그인 역할 생성 - SVM SVM_이름 - 역할 SVM_SVM_역할_이름 - cmddirname "LUN" - 모두 액세스'
...
* '보안 로그인 역할 생성 - vserver SVM_Name - role SVM_SVM_Role_Name - cmddirname "lun mapping create" - access all'
...
* '보안 로그인 역할 생성 - vserver SVM_Name - role SVM_SVM_Role_Name - cmddirname "network interface" - 액세스 읽기 전용'
...
* '보안 로그인 역할 생성 - vserver SVM_name - role SVM_Role_Name - cmddirname "vserver export-policy show" - 액세스 모든 ``보안 로그인 역할 생성 - vserver SVM_Name - role SVM_SVM_Role_Name - cmddirname "vserver iscsi connection show" - 모두 액세스'
...
* '보안 로그인 역할 생성 - vserver SVM_Name - role SVM_SVM_Role_Name - cmddirname "volume clone split status" - 모두 액세스'
