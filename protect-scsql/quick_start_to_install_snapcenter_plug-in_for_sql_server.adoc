...
ONTAP 및 응용 프로그램 플러그인의 최소 요구 사항은 https://imt.netapp.com/matrix/imt.jsp?components=121030;&solution=1259&isHWU&src=IMT[] [상호 운용성 매트릭스 도구] 를 참조하십시오.
...
운영 체제(64비트)
 a| 
을 참조하십시오 https://imt.netapp.com/matrix/imt.jsp?components=121030;&solution=1259&isHWU&src=IMT["상호 운용성 매트릭스 툴"^]
...
NOTE: SnapCenter 리포지토리가 설치된 동일한 호스트에 SnapCenter 서버가 있는 경우 15GB를 사용하는 것이 좋습니다.
