...
* SnapCenter 6.2.1 이상 버전을 사용하려면 호스트에 Java 17(Oracle Java, OpenJDK 또는 SAP JDK)이 설치되어 있어야 하고, SnapCenter 6.2 이하 버전을 사용하려면 Java 11이 설치되어 있어야 합니다.
+
...
* MySQL 8.0 이전 버전을 사용 중이라면 MySQLX 플러그인을 수동으로 설치하고 활성화해야 합니다. MySQLX 플러그인은 MySQL 8.0 이상 버전에서 기본적으로 설치 및 활성화되어 있습니다.
...
* SnapCenter 6.2.1 이상 버전을 사용하려면 Windows 호스트에 Java 17(Oracle Java, OpenJDK 또는 SAP JDK)이 설치되어 있어야 하고, SnapCenter 6.2 이하 버전을 사용하려면 Java 11이 설치되어 있어야 합니다.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["모든 운영 체제용 Java 다운로드"]
