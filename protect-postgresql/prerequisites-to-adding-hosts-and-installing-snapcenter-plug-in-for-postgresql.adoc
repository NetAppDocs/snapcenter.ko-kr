...
* 호스트에 Java 17(SnapCenter 6.2.1 이상 버전) 또는 Java 11(SnapCenter 6.2 이하 버전)이 설치되어 있어야 합니다.
+
...
* Windows 호스트에 Java 17(SnapCenter 6.2.1 이상 버전) 또는 Java 11(SnapCenter 6.2 이하 버전)이 설치되어 있어야 합니다.
+
...
* 루트 또는 루트 이외의 사용자에 대해 암호 기반 SSH 연결을 활성화해야 합니다.
* Linux 호스트에 Java 17(SnapCenter 6.2.1 이상 버전) 또는 Java 11(SnapCenter 6.2 이하 버전)이 설치되어 있어야 합니다.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["모든 운영 체제용 Java 다운로드"]
