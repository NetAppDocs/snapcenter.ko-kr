...
summary: IBM DB2 백업 복원에는 SnapCenter 서버와의 연결 세션 시작, 백업 나열 및 백업 정보 검색, 백업 복원 등이 포함됩니다. 
---
= PowerShell cmdlet을 사용하여 IBM DB2 데이터베이스를 복구합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
IBM DB2 백업 복원에는 SnapCenter 서버와의 연결 세션 시작, 백업 나열 및 백업 정보 검색, 백업 복원 등이 포함됩니다.
