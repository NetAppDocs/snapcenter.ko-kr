...
* 루트 또는 루트 이외의 사용자에 대해 암호 기반 SSH 연결을 활성화해야 합니다.
* SnapCenter 6.2.1 이상 버전을 사용하려면 Linux 또는 AIX 호스트에 Java 17(Oracle Java, OpenJDK 또는 SAP JDK)이 설치되어 있어야 하고, SnapCenter 6.2 이하 버전을 사용하려면 Java 11이 설치되어 있어야 합니다.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Linux용 Java 다운로드"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["AIX용 Java 다운로드"^]
