...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Windows용 JAVA 다운로드"^]
...
* 루트 또는 루트 이외의 사용자에 대해 암호 기반 SSH 연결을 활성화해야 합니다.
* Linux 또는 AIX 호스트에 Java 11이 설치되어 있어야 합니다.
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Linux용 JAVA 다운로드"^]
