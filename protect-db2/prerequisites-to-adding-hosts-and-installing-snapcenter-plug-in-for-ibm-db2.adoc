...
* 호스트에 Java 17, Java 11(SnapCenter 6.2의 경우에만 해당)이 설치되어 있어야 합니다.
+
...
* Windows 호스트에 Java 17, Java 11(SnapCenter 6.2의 경우에만 해당)이 설치되어 있어야 합니다.
+
...
* 루트 또는 루트 이외의 사용자에 대해 암호 기반 SSH 연결을 활성화해야 합니다.
* Linux 또는 AIX 호스트에 Java 17, Java 11(SnapCenter 6.2의 경우에만 해당)이 설치되어 있어야 합니다.
+
