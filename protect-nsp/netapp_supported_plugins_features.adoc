...
summary: SnapCenter는 플러그인 애플리케이션 및 스토리지 시스템의 NetApp 기술과 통합됩니다. NetApp 지원 플러그인으로 작업하려면 SnapCenter 그래픽 사용자 인터페이스를 사용합니다. 
---
...
[role="lead"]
SnapCenter는 플러그인 애플리케이션 및 스토리지 시스템의 NetApp 기술과 통합됩니다. NetApp 지원 플러그인으로 작업하려면 SnapCenter 그래픽 사용자 인터페이스를 사용합니다.
...
* * 무중단 NetApp 스냅샷 기술 *
+
SnapCenter는 NetApp Snapshot 기술을 NetApp 지원 플러그인과 함께 사용하여 리소스를 백업합니다. 스냅샷은 최소한의 스토리지 공간을 사용합니다.



또한 NetApp 지원 플러그인 기능을 사용하면 다음과 같은 이점이 있습니다.
