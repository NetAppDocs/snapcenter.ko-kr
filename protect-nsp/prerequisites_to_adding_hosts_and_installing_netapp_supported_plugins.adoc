...
* SnapCenter 6.2.1 이상 버전을 사용하려면 Java 17(Oracle Java 또는 OpenJDK)이 설치되어 있어야 합니다
* Linux, Windows 또는 AIX 호스트에서 SnapCenter 6.2 이하 버전을 사용하려면 Java 11이 필요합니다.
+
...
+
SnapCenter 서버 호스트로 Windows Server 2019 또는 Windows Server 2016을 사용하는 경우 SnapCenter 6.2.1 이상 버전에는 Java 17(Oracle Java 또는 OpenJDK)을, SnapCenter 6.2 이하 버전에는 Java 11을 설치해야 합니다.
...
필요한 소프트웨어 패키지
 a| 
* SnapCenter 6.2.1 이상 버전용 Java 17, IBM Java 또는
* SnapCenter 6.2 이하 버전용 Java 11, IBM Java
