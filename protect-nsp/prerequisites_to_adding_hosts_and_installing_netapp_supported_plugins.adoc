...
* Linux, Windows 또는 AIX 호스트에 Java 17, Java 11(SnapCenter 6.2의 경우에만 해당)이 설치되어 있어야 합니다.
+
...
+
Windows Server 2019 또는 Windows Server 2016을 SnapCenter 서버 호스트로 사용하는 경우 Java 17, Java 11(SnapCenter 6.2에만 해당)을 설치해야 합니다.
...
필요한 소프트웨어 패키지
 a| 
Java 17, Java 11(SnapCenter 6.2 전용), IBM Java
