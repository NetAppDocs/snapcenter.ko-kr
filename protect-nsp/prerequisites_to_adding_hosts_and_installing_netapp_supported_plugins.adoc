...
* Linux, Windows 또는 AIX 호스트에 Java 17이 설치되어 있어야 합니다.
+
...
* Linux 호스트에 Java 17이 설치되어 있어야 합니다.
+
SnapCenter 서버 호스트로 Windows Server 2019 또는 Windows Server 2016을 사용하는 경우 Java 17을 설치해야 합니다.
