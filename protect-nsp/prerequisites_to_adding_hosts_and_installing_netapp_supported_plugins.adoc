...
* SnapCenter 6.2.1 이상 버전을 사용하려면 Linux, Windows 또는 AIX 호스트에 Java 17(Oracle Java, OpenJDK 또는 SAP JDK)이 설치되어 있어야 하고, SnapCenter 6.2 이하 버전을 사용하려면 Java 11이 설치되어 있어야 합니다.
+
...
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Windows용 Java 다운로드"]
...
* SnapCenter 6.2.1 이상 버전을 사용하려면 Linux 호스트에 Java 17(Oracle Java, OpenJDK 또는 SAP JDK)이 설치되어 있어야 하고, SnapCenter 6.2 이하 버전을 사용하려면 Java 11이 설치되어 있어야 합니다.
+
SnapCenter 서버 호스트로 Windows Server 2019 또는 Windows Server 2016을 사용하는 경우 SnapCenter 6.2.1 이상 버전에는 Java 17(Oracle Java, OpenJDK 또는 SAP JDK)을, SnapCenter 6.2 이하 버전에는 Java 11을 설치해야 합니다.

+
link:https://www.oracle.com/java/technologies/downloads/#java17["Linux용 Java 다운로드"]
...
필요한 소프트웨어 패키지
 a| 
* SnapCenter 6.2.1 및 이후 버전용 Java 17, IBM Java 또는 SnapCenter 6.2 및 이전 버전용 Java 11, IBM Java
