...
SnapCenter Standard 라이센스는 컨트롤러 기반 라이센스로, NetApp ONTAP One에 포함되어 있습니다. SnapManager 제품군 라이센스가 있는 경우 SnapCenter 표준 라이센스 사용 권한도 제공됩니다. FAS, AFF 또는 ASA 스토리지를 사용하여 SnapCenter를 평가판으로 설치하려면 영업 담당자에게 문의하여 NetApp ONTAP One 평가판 라이센스를 받을 수 있습니다.

NetApp ONTAP One에 포함된 라이센스에 대한 자세한 내용은 을 https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["NetApp ONTAP One에 포함된 라이선스"]참조하십시오.
