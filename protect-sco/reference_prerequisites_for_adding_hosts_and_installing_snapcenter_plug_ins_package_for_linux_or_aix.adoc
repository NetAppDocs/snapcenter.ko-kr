...
* SnapCenter 6.2.1 이상의 경우 Java 17을 설치해야 합니다.
* Linux 또는 AIX 호스트에 Java 11(SnapCenter 6.2 이하 버전의 경우)이 설치되어 있어야 합니다.
+
** Linux에서는 Oracle Java와 OpenJDK가 지원됩니다.
...
필요한 소프트웨어 패키지
 a| 
* SnapCenter 6.2.1 이상의 경우 Java 17(Oracle 또는 OpenJDK) 또는
* SnapCenter 6.2 이하 버전용 Java 11
...
필요한 소프트웨어 패키지
 a| 
* SnapCenter 6.2.1 이상 버전용 IBM Java 17 또는
* SnapCenter 6.2 이하 버전을 위한 IBM Java 11
