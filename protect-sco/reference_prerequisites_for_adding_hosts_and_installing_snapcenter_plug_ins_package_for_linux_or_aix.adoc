...
* Linux 또는 AIX 호스트에 Java 17 또는 Java 11(SnapCenter 6.2의 경우에만 해당)이 설치되어 있어야 합니다.
+
...
필요한 소프트웨어 패키지
 a| 
Java 17(Oracle 또는 OpenJDK), Java 11(SnapCenter 6.2에만 해당)
...
필요한 소프트웨어 패키지
 a| 
IBM Java 17, IBM Java 11(SnapCenter 6.2에만 해당)
