...
+
ASM_diskstring 매개 변수를 편집하는 방법에 대한 자세한 내용은 을 참조하십시오 https://["ASM_diskstring에 디스크 경로를 추가하는 방법"^].
...
+
**** https://["Linux 호스트 유틸리티 설치 및 설정 안내서"^]
**** https://["AIX 호스트 유틸리티 설치 및 설정 안내서"^]
