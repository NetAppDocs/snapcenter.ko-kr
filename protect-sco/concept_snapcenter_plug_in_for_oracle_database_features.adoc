...
** LUNPATH_MONITORING_INTERVAL 매개변수에 값(시간)을 할당하여 LUN 경로가 자동으로 수정되는 빈도를 지정할 수 있습니다. SLM에 대한 자세한 내용은 를 https://docs.netapp.com/us-en/ontap/san-admin/index.html["ONTAP 9 SAN 관리 섹션을 참조하십시오"^]참조하십시오.
