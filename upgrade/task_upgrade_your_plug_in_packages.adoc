...
* Windows 플러그인 호스트에 PowerShell 7.4.13이 설치되어 있는지 확인하십시오.
* Windows 및 Linux 플러그인 호스트에 Java 17(Oracle Java 또는 OpenJDK)이 설치되어 있는지 확인하십시오(SnapCenter 6.2의 경우에만 Java 11).
