...
* Windows 플러그인 호스트에 ASP.NET Core Runtime 8.0.24(및 이후의 모든 8.0.x 패치) Hosting Bundle과 PowerShell 7.4.13 이상이 설치되어 있는지 확인하십시오.
* SnapCenter 6.2.1 이상 버전의 경우 Java 17(Oracle Java 또는 OpenJDK)이, SnapCenter 6.2 이하 버전의 경우 Java 11이 Windows 및 Linux 플러그인 호스트에 설치되어 있는지 확인하십시오.
