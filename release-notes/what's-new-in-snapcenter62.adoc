...
summary: SnapCenter software 6.2 버전에는 여러 가지 새로운 기능과 개선 사항이 포함되어 있습니다. 
---
...
[role="lead"]
SnapCenter 소프트웨어 6.2 릴리스에는 알려진 버그 수정 사항과 SnapCenter 서버 및 플러그인의 적격 버전 업데이트가 포함되어 있습니다. 또한 다음과 같은 확장 기능도 포함되어 있습니다. 자세한 내용은 link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter 6.2.2 릴리스 노트"^]을 참조하십시오.
