...
* SnapCenter 재해 복구 기능은 REST API를 사용하여 SnapCenter 서버를 백업합니다. 을 참조하십시오 link:../tech-refresh/task_tech_refresh_server_host.html["SnapCenter 서버의 재해 복구를 위한 REST API 워크플로우"].
