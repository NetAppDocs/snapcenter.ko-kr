...
+
REST API에 대한 자세한 내용은 를 참조하십시오 https://["REST API 개요"].

+
Windows cmdlet에 대한 자세한 내용은 을 참조하십시오 https://["SnapCenter 소프트웨어 cmdlet 참조 가이드"^].

+
UNIX 명령에 대한 자세한 내용은 을 참조하십시오 https://["SnapCenter 소프트웨어 명령 참조 가이드"^].
...
* SnapCenter 맞춤형 플러그인
+
사용자 지정 플러그인은 커뮤니티에서 지원되며 에서 다운로드할 수 있습니다 https://["NetApp 스토리지 자동화 스토어"^].
...
SnapCenter 소프트웨어용 MySQL, DB2 및 MongoDB 맞춤형 플러그인 샘플은 에서 다운로드할 수 있습니다 https://["NetApp 스토리지 자동화 스토어"^].
