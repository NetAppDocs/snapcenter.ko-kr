...
** ONTAP FAS, AFF 또는 ASA 운영 및 2차 시스템에 있고 로컬 StorageGRID 오브젝트 스토리지로 보호되는 데이터(NetApp BlueXP 클라우드 백업 통합 사용)


* 하이브리드 클라우드의 사내 로 다음을 보호:
+
** ONTAP FAS, AFF 또는 ASA 기본 시스템에 있고 Cloud Volumes ONTAP에 복제된 데이터입니다
** ONTAP FAS, AFF 또는 ASA 운영 및 2차 시스템에 있고 클라우드의 오브젝트 및 아카이브 스토리지로 보호되는 데이터(NetApp BlueXP 클라우드 백업 통합 사용)
...
+
Windows cmdlet에 대한 자세한 내용은 을 참조하십시오 https://library.netapp.com/ecm/ecm_download_file/ECMLP2886205["SnapCenter 소프트웨어 cmdlet 참조 가이드"^].
