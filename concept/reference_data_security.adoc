...
+
자세한 내용은 을 참조하십시오 https://["지원되는 SSL 암호화 제품군을 구성하는 방법"].
...
* IPsec은 Windows 및 Linux 호스트 시스템용 ONTAP의 SnapCenter에서 지원됩니다. https://["자세한 정보"].
...
* SnapCenter 서버와 ONTAP 간의 CA 인증서 인증을 지원합니다. https://["자세한 정보"].
...
VMware vSphere용 SnapCenter 플러그인용 CA 인증서를 구축할 수도 있습니다. 자세한 내용은 을 참조하십시오 https://["인증서를 만들고 가져옵니다"^].
